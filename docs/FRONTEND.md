...
| **Screens still stubbed** | Collections tab, discounts, team, invoices, orders list, org switcher | Their services are live now, so these are buildable — no longer blocked on the backend |
